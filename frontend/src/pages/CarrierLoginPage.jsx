...
const CarrierLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        const response = await authAPI.carrierLogin({ email, password })
        login(response.data.token, response.data.carrier, 'carrier')
        navigate('/carrier')
      } else {
        const response = await authAPI.carrierRegister({
          email,
          password,
          phone,
          firstname,
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Carrier Portal</p>
          </div>
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={vehInfo}
                    onChange={(e) => setVehInfo(e.target.value)}
